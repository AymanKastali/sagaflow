...
func (x *HoldSeat) GetBookingId() string {
	if x != nil {
		return x.BookingId
	}
	return ""
...
func (x *HoldSeat) GetSeatId() string {
	if x != nil {
		return x.SeatId
	}
	return ""
...
func (x *HoldSeat) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
const file_sagaflow_inventory_v1_hold_seat_proto_rawDesc = "" +
	...
	"\x19com.sagaflow.inventory.v1B\rHoldSeatProtoP\x01ZLgithub.com/AymanKastali/sagaflow/contracts/sagaflow/inventory/v1;inventoryv1\xa2\x02\x03SIX\xaa\x02\x15Sagaflow.Inventory.V1\xca\x02\x15Sagaflow\\Inventory\\V1\xe2\x02!Sagaflow\\Inventory\\V1\\GPBMetadata\xea\x02\x17Sagaflow::Inventory::V1b\x06proto3"
